Dentro del directorio "src", se encuentra el directorio "Componentes". En este último se han implementado los componentes utilizando hooks de React para las siguientes funcionalidades:
